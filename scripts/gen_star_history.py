#!/usr/bin/env python3
"""Render this repo's star history as a PNG image (light theme).

Fetches stargazer timestamps from the GitHub REST API and draws a cumulative
"stars over time" chart with a gradient fill.
Output: asset/star-history.png
...
REPO = "TingsongYu/PyTorch-Tutorial-2nd"
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default="asset")
